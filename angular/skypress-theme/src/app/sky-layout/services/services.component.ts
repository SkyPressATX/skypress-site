  ...
  ngOnInit() {
      this.services = [
        ...
        },
        {
            ...
            description: 'Businesses aren’t operated by a single program. Instead, we use the appropriate services that satisfy our needs. SkyPress can help with the integration of your web application and your existing business tools in order to streamline your daily workflow.'
        },
        {
            icon: 'ion-fireball',
            title: 'WAR Framework',
